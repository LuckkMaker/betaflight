;/**
; * @file       startup_apm32f423xx.s
; *
; * @brief      CMSIS Cortex-M4 based Core Device Startup File for Device startup_apm32f423xx
; *
; * @version    V1.0.0
; *
; * @date       2025-12-15
...
__vector_table
        ...
        DCD     Reset_Handler             ; Reset Handler
                ...
                DCD     OTG_FS_WKUP_IRQHandler          ; OTG_FS1 Wakeup through EINT line
                ...
                DCD     0                               ; Reserved
                DCD     0                               ; Reserved
                DCD     OTG_FS2_WKUP_IRQHandler         ; OTG_FS2 Wakeup through EINT line
                DCD     OTG_FS2_IRQHandler              ; OTG_FS2
...
FPU_IRQHandler
        ...
        PUBWEAK OTG_FS2_WKUP_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
OTG_FS2_WKUP_IRQHandler
        B OTG_FS2_WKUP_IRQHandler

        PUBWEAK OTG_FS2_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
OTG_FS2_IRQHandler
        B OTG_FS2_IRQHandler
